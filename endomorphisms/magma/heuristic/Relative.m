...
{Returns distinguished subfield.}
...
intrinsic ExtendNumberFieldExtra(g::RngUPolElt) -> Fld
...
if #Ks eq 1 then
    ...
    L, psis := CompositumExtra(Ks[1], Ks[2]);
    return L, psis;
end if;
