...
cases := [*
    <"28561.c1", 8, ["CC", "CC"], ["CC", "CC"],
        [0, 0, -2, 2, 2, -3, -2], [1]>,
    <"3125.a1", 8, ["M_4(RR)"], ["CC", "CC"],
        [0, 0, 0, 0, 0, -1], [1]>,
    <"20736.ce1", 8, ["M_2(RR)"], ["M_2(RR)"],
        [0, -2, 0, 5, -3, -5, 1], [1, 1, 1, 1]>,
    <"8100.o1", 8, ["M_2(CC)"], ["M_2(RR)"],
        [1, 3, -42, 43, 21, -60, -28], [1]>,
    <"8192.d1", 8, ["M_2(RR)", "RR"], ["CC", "CC"],
        [-2, 0, 8, 0, -9, 0, 2], []>,
    <"729.a1", 8, ["M_2(CC)"], ["M_2(CC)"],
        [16, 0, 0, -5], [0, 0, 0, 1]>,
    <"529.a1", 8, ["RR", "RR"], ["RR", "RR"],
        [0, 1, 0, -1, 0, -1], [1, 0, 1, 1]>,
    <"121.a1", 8, ["M_2(RR)"], ["M_2(RR)"],
        [-2, 4, 2, 5, 2, 1], [1, 1, 1, 1]>,
    <"6859.a1", 8, ["CC", "RR"], ["CC", "RR"],
        [0, -1, -1, -11, -4, -16, 16], [1]>,
    <"363.a1", 8, ["RR", "RR"], ["RR", "RR"],
        [0, -1, 0, -2, 4, -2], [0, 1, 0, 1]>
*];
...
procedure test_tuple_28561()
    ...
    ok, msg, eta, t, output, total_dim := EndomorphismAlgebraUpperBound(C, 8);
